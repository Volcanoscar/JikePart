	...
	protected void onSaveInstanceState(Bundle outState) {// 保存界面状态，记录点击TextView前是单程还是往返
		try {
			...
			outState.putSerializable("startdate_tv", startdate_tv.getText()
					.toString());
			outState.putSerializable("enddate_tv", enddate_tv.getText()
					.toString());
			outState.putSerializable("startoff_date_tv", startoff_date_tv
					.getText().toString());
			outState.putSerializable("startcity_tv", startcity_tv.getText()
					.toString());
			outState.putSerializable("endcity_tv", endcity_tv.getText()
					.toString());
			outState.putSerializable("startcity_code_tv", startcity_code_tv
					.getText().toString());
			outState.putSerializable("endcity_code_tv", endcity_code_tv
					.getText().toString());
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void onRestoreInstanceState(Bundle savedState) {// 根据之前保存的状态，恢复页面状态
		try {
			...
			startdate_tv.setText(savedState.getSerializable("startdate_tv")
					.toString());
			enddate_tv.setText(savedState.getSerializable("enddate_tv")
					.toString());
			startoff_date_tv.setText(savedState.getSerializable(
					"startoff_date_tv").toString());
			endcity_tv.setText(savedState.getSerializable("endcity_tv")
					.toString());
			startcity_tv.setText(savedState.getSerializable("startcity_tv")
					.toString());
			endcity_code_tv.setText(savedState.getSerializable(
					"endcity_code_tv").toString());
