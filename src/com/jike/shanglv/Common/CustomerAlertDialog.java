...
public class CustomerAlertDialog {
	...
	TextView dialog_title_tv,dialog_content_tv,dialog_cancel_tv,dialog_ok_tv;
	public CustomerAlertDialog(Context context,Boolean isOneBtn) {
		...
		dialog_title_tv=(TextView)window.findViewById(R.id.dialog_title_tv);
		dialog_content_tv=(TextView)window.findViewById(R.id.dialog_content_tv);
	...
	public void setPositiveButton(String text,OnClickListener onClickListener) {
		dialog_ok_tv.setText(text);
		dialog_ok_tv.setOnClickListener((android.view.View.OnClickListener) onClickListener);
	}
