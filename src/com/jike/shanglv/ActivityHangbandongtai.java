...
public class ActivityHangbandongtai extends Activity {
	...
	private SingleOrDouble wayType = SingleOrDouble.singleWay; // 单程:按起降城市  or  往返：按航班号
...
//					new AlertDialog.Builder(context).setTitle("请输入要查询的航班号码").setPositiveButton("确定", null).show();
				...
				Intent intents=new Intent(context,ActivityHangbandongtaiSearchlist.class);
				intents.putExtra("wayType", wayType);
				intents.putExtra("flightNo", flightno_cet.getText().toString().trim());
