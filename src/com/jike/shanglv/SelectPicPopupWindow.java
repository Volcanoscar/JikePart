...
public class SelectPicPopupWindow extends PopupWindow {
	 ...
	 * */
	public SelectPicPopupWindow(Activity context,List<Map<String, Object>> list,int currentID,OnClickListener itemsOnClick) {
		super(context);
		this.currentID=currentID;
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View view = inflater.inflate(R.layout.alert_bottom_dialog, null);
		ListView baoxian_listview =(ListView) view.findViewById(R.id.baoxian_listview);
...
//		this.setOutsideTouchable(true);// 触摸popupwindow外部，popupwindow消失。
	...
	public class MyListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView==null) {
				myHolder=new Holder();
				convertView=inflater.inflate(R.layout.item_train_baoxian_list_single, null);
