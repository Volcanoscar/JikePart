			...
			case COMMITMSG:
				...
				try {
					...
					if (state.equals("0000")) {
						...
						int paysystype=14;
						String siteid=sp.getString(SPkeys.siteid.getString(), "65");
						String sign=CommonFunc. MD5(orderId + paymoney_tv.getText().toString().trim().substring(1) + userid + paysystype + siteid);
						MyApp ma = new MyApp(context);
						...
						String url=String.format(ma.getPayServeUrl(),orderId, paymoney_tv.getText().toString().trim().substring(1),userid,paysystype,siteid,sign);
