...
public class ActivityHotelIntroduce extends Activity {
	...
	private TextView hotel_introduce_tv,hotel_sheshi_tv,hotel_traffic_tv,hotel_address_tv;
	...
	private void initView() {
		...
		home_imgbtn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				startActivity(new Intent(ActivityHotelIntroduce.this,MainActivity.class));
			}
		});
	}
