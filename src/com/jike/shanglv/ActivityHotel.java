...
public class ActivityHotel extends Activity {
	...
	private Button search_button, buxian_xingji_btn, wuxingji_btn,
			sixingji_btn, sanxingji_btn, erxingji_btn, buxian_price_btn,
			ybw_yixia_btn, ybw_sb_btn, sly_swl_btn, swy_lb_btn, lly_yq_btn,
			yq_yishang_btn;
	...
	private void initView() {
		...
		// popupWindow_xingji.setHeight(popupWindowView_xingji.getMeasuredHeight()
		// + 20);
		...
		// popupWindow_xingji = new
		// PopupWindow(popupWindowView_xingji,LayoutParams.FILL_PARENT,
		// height_xingji, true);
		...
		// buxian_xingji_btn=(Button)
		// popupWindowView_xingji.findViewById(R.id.buxian_xingji_btn);
		// wuxingji_btn=(Button)
		// popupWindowView_xingji.findViewById(R.id.wuxingji_btn);
		// sixingji_btn=(Button)
		// popupWindowView_xingji.findViewById(R.id.sixingji_btn);
		// sanxingji_btn=(Button)
		// popupWindowView_xingji.findViewById(R.id.sanxingji_btn);
		// erxingji_btn=(Button)
		// popupWindowView_xingji.findViewById(R.id.erxingji_btn);
		// buxian_price_btn=(Button)
		// popupWindowView_jiage.findViewById(R.id.buxian_price_btn);
		// ybw_yixia_btn=(Button)
		// popupWindowView_jiage.findViewById(R.id.ybw_yixia_btn);
		// ybw_sb_btn=(Button)
		// popupWindowView_jiage.findViewById(R.id.ybw_sb_btn);
		// sly_swl_btn=(Button)
		// popupWindowView_jiage.findViewById(R.id.sly_swl_btn);
		// swy_lb_btn=(Button)
		// popupWindowView_jiage.findViewById(R.id.swy_lb_btn);
		// lly_yq_btn=(Button)
		// popupWindowView_jiage.findViewById(R.id.lly_yq_btn);
		// yq_yishang_btn=(Button)
		// popupWindowView_jiage.findViewById(R.id.yq_yishang_btn);
	...
	private void iniPopupWindow(final int xjOrJg,
		...
		layout.setOnTouchListener(new OnTouchListener() {
			public boolean onTouch(View v, MotionEvent event) {
				...
				// lvPopupList = (ListView)
				// layout.findViewById(R.id.lv_popup_list);
