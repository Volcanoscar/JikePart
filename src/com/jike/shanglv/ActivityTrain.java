...
public class ActivityTrain extends Activity {
	...
	private TextView  startcity_tv, endcity_tv,	startcity_code_tv, endcity_code_tv,startoff_date_tv;
	...
	View.OnClickListener btnClickListner = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.search_button://搜索
				...
				Intent intents=new Intent(context,ActivityTrainSearchlist.class);
