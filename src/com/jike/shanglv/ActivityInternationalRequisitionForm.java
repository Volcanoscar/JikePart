...
public class ActivityInternationalRequisitionForm extends Activity {
	...
	private TextView startCity_tv,arriveCity_tv,startDate_tv,arriveDate_tv,add_passager_tv,baoxian_price_and_count_tv;
	...
	private ImageButton lianxiren_icon_imgbtn,back_imgbtn, home_imgbtn,baoxian_check_imgbtn;
...
//{"c":"0000","d":"BX1408261127020127"}
					if (state.equals("0000")) {
						...
						intent.putExtra(
								ActivityInternationalRequisitionSuccess.RECEIPT_ORDER_ID,orderID);
...
//				}
	...
	private String getStr(){
		...
		interDemandStr.setfType(wayType == SingleOrDouble.singleWay?"0":"1");
	...
	public ArrayList<Passenger> removeDuplictePassengers(
		...
		Set<Passenger> s = new TreeSet<Passenger>(new Comparator<Passenger>() {
			...
			public int compare(Passenger o1, Passenger o2) {
				if (o1.getPassengerName()!=null&&o2.getPassengerName()!=null) {
