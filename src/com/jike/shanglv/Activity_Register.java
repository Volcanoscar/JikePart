...
public class Activity_Register extends Activity {
	...
	private EditText uername_input_et, password_input_et, confirm_input_et,
			mobile_input_et, email_input_et, recommend_input_et,realname_input_et;
	...
	private void startRegister() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				String str = "{\"regCode\":\"" +recommend_input_et.getText().toString().trim()
						+"\",\"loginName\":\"" +uername_input_et.getText().toString().trim()
						+"\",\"phone\":\"" +mobile_input_et.getText().toString().trim()
						+"\",\"loginPass\":\"" +password_input_et.getText().toString().trim()
						+"\",\"realName\":\"" +realname_input_et.getText().toString().trim()
						+"\",\"email\":\"" +email_input_et.getText().toString().trim()
						+"\"}";
